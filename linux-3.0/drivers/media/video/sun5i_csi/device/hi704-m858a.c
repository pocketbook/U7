...
static struct regval_list sensor_default_regs[] = {
	...
	{{0x12}, {0x04}},//brian 20120308 04->05
	...
	{{0x48}, {0x90}}, //Contrast  88->84  _100318   brian 90->94
	{{0x50}, {0x48}}, //AGBRT
	...
	{{0x64}, {0x48}}, //AGSAT
	{{0x66}, {0x90}}, //wht_th2
	{{0x67}, {0x67}}, //wht_gain  Dark (0.4x), Normal (0.75x)
	...
	{{0x87}, {0x48}}, //RMAXB Default : 50, 4d
	{{0x88}, {0x38}}, //RMINB Default : 3e, 45 --> 42
	{{0x89}, {0x3e}}, //BMAXB Default : 2e, 2d --> 30
	{{0x8a}, {0x18}}, //BMINB Default : 20, 22 --> 26 --> 29
	{{0x8b}, {0x02}}, //OUT TH
	{{0x8d}, {0x22}},
	{{0x8e}, {0x71}},
...
static struct regval_list sensor_qvga_regs[] = {
	...
	{{0x40}, {0x01}},//HBLANK: 0x70 = 344
	{{0x41}, {0x58}},
	{{0x42}, {0x00}},//VBLANK: 0x04 = 20
	{{0x43}, {0x14}},
